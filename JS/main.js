...
class LoadManager {
    ...
    static Init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var timing = yield DOMEventsAsync(document);
            yield DoEvents();
            yield timing[0];
...
function AttachCanceller(p) {
    ...
    res[1] = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        res[0] = () => {
            if (resolve) {
                resolve([false, null]);
                resolve = null;
